 ...
 */
export const useReadCounterScriptundefined =
  /*#__PURE__*/ createUseReadContract({ abi: counterScriptAbi })
...
/**
 * Wraps __{@link useReadContract}__ with `abi` set to __{@link counterScriptAbi}__ and `functionName` set to `"counter"`
 */
export const useReadCounterScriptCounter = /*#__PURE__*/ createUseReadContract({
 ...
 */
export const useWriteCounterScriptundefined =
  /*#__PURE__*/ createUseWriteContract({ abi: counterScriptAbi })
 ...
 */
export const useSimulateCounterScriptundefined =
  /*#__PURE__*/ createUseSimulateContract({ abi: counterScriptAbi })
